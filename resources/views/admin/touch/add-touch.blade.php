...
@section('body')
    ...
    <form class="form-horizontal" action="{{ url('/save-touch') }}" method="post">
        @csrf
        <div class="well">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <input name="font" type="text" class ="form-control">
                    <span style="color: red"> {{ $errors->has('service_image') ? $errors->first('service_image') : ' ' }}</span>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <div class="col-sm-offset-3 col-sm-7">
                    <button type="submit" name="btn" class="btn btn-block btn-primary">Save Touch Info</button>
                </div>
            </div>
        </div>
    </form>
